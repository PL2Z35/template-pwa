...
import { isAuthenticate } from '@/config/petitions';
                ...
                message={
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingLeft: '30px', paddingRight: '30px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <Button size='large' style={{ backgroundColor: 'white', color: '#be00e0', border: '1px solid #be00e0', padding: '10px 20px' }} href='/auth/signup'><strong>Crear Cuenta</strong></Button>
                        </div>
                    </div>
                }
                type="info"
                ...
                message={
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingLeft: '30px', paddingRight: '30px' }}>
                        ...
                        <div style={{ alignItems: 'center' }}>
                            ...
                            <Button size='large' style={{ marginRight: '10px', backgroundColor: 'white', color: '#be00e0', border: '1px solid #be00e0', padding: '10px 20px' }} href='/auth/signup'><strong>Crear Cuenta</strong></Button>
                        </div>
                    </div>
                }
                type="info"
